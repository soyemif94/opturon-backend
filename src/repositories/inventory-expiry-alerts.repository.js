...
function normalizeDateOnly(value) {
  if (value instanceof Date) {
    ...
    // node-postgres parses PostgreSQL DATE as local midnight. Preserve those
    // local calendar components instead of serializing it as an instant, which
    // could shift the represented day in timezones east of UTC.
